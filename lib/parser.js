...
Parser.prototype = {
  ...
  parseExtends: function(){
    ...
    var str = this.readVirtualFile(path) || fs.readFileSync(path, 'utf8');
  ...
  parseInclude: function(){
    ...
    // has-filter
    if (tok.filter) {
      var str = this.readVirtualFile(path) || fs.readFileSync(path, 'utf8').replace(/\r/g, '');
  ...
  /**
   * virtual file trumps fs?
   */

  readVirtualFile: function(path){
    return this.options.virtualFiles ? this.options.virtualFiles(path) : false;
  },
